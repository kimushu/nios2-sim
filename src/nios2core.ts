...
export function exec(iw: number) {
    return call_op(iw, "exec", this);
}

export function disas(iw: number) {
    return call_op(iw, "disas", this);
}

export function reset() {
    this.gpr = new Int32Array(32);
    this.gpr.fill(0xdeadbeef);
    this.gpr[0] = 0;
}
...
function D_OR(m: string, v: string, x: number): string {
    return m + "\t" + v + "(" + GPRN[x] + ")";
}
...
def(0x03, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.dread8(this.gpr[ra] + s16);
}, function (ra, rb, s16) {
    return D_ROR("ldbu", rb, s16, ra);
});

def(0x04, TYPE_I, function (ra, rb, s16) {
...
def(0x0f, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = SE16(this.dread16(this.gpr[ra] + s16));
}, function (ra, rb, s16) {
    return D_ROR("ldh", rb, s16, ra);
});

def(0x10, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.gpr[ra] < s16 ? 1 : 0;
}, function (ra, rb, s16) {
    return D_RRD("cmplti", rb, ra, s16);
});

def(0x13, TYPE_I, function (ra, rb, s16) {
    throw 0;
}, function (ra, rb, s16) {
    return D_OR("initda", s16, ra);
});

def(0x14, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.gpr[ra] | (s16 & 0xffff);
}, function (ra, rb, s16) {
    if (ra === ZR) {
...
def(0x15, TYPE_I, function (ra, rb, s16) {
    this.dwrite32(this.gpr[ra] + s16, this.gpr[rb]);
}, function (ra, rb, s16) {
    return D_ROR("stw", rb, s16, ra);
});

def(0x16, TYPE_I, function (ra, rb, s16) {
    if (this.gpr[ra] < this.gpr[rb]) {
        return this.pc + 4 + s16;
    }
}, function (ra, rb, s16) {
...
def(0x17, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.dread32(this.gpr[ra] + s16, 4);
}, function (ra, rb, s16) {
    return D_ROR("ldw", rb, s16, ra);
});

def(0x18, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.gpr[ra] !== s16 ? 1 : 0;
}, function (ra, rb, s16) {
    return D_RRD("cmpnei", rb, ra, s16);
});

def(0x1b, TYPE_I, function (ra, rb, s16) {
    throw 0;
}, function (ra, rb, s16) {
    return D_OR("flashda", s16, ra);
});

def(0x1c, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.gpr[ra] ^ (s16 & 0xffff);
}, function (ra, rb, s16) {
    return D_RRD("xori", rb, ra, s16 & 0xffff);
});

def(0x1e, TYPE_I, function (ra, rb, s16) {
    if (this.gpr[ra] !== this.gpr[rb]) {
        return this.pc + 4 + s16;
    }
}, function (ra, rb, s16) {
...
def(0x20, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.gpr[ra] === s16 ? 1 : 0;
}, function (ra, rb, s16) {
    return D_RRD("cmpeqi", rb, ra, s16);
});

def(0x23, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.ioread8(this.gpr[ra] + s16);
}, function (ra, rb, s16) {
    return D_ROR("ldbuio", rb, s16, ra);
});

def(0x24, TYPE_I, function (ra, rb, s16) {
    if (!this.cfg.mul) {
        throw "Unsupported";
    }
    throw 0;
...
def(0x33, TYPE_I, function (ra, rb, s16) {
    throw 0;
}, function (ra, rb, s16) {
    return D_OR("initd", s16, ra);
});

def(0x34, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.gpr[ra] | (s16 << 16);
}, function (ra, rb, s16) {
    if (ra === ZR) {
...
def(0x38, TYPE_I, function (ra, rb, s16) {
    throw 0;
}, function (ra, rb, s16) {
    return D_RRD("rdprs", rb, ra, s16);
});

def(0x3b, TYPE_I, function (ra, rb, s16) {
    throw 0;
}, function (ra, rb, s16) {
    return D_OR("flashd", s16, ra);
});

def(0x3c, TYPE_I, function (ra, rb, s16) {
    this.gpr[rb] = this.gpr[ra] ^ (s16 << 16);
}, function (ra, rb, s16) {
    return D_RRD("xorhi", rb, ra, s16 & 0xffff);
});

def(0x013a, TYPE_R, function (ra, rb, rc) {
    this.st = this.est;
    return this.gpr[EA];
}, function (ra, rb, rc) {
    return D_N("eret");
...
def(0x023a, TYPE_R, function (ra, rb, rc, opx) {
    var tmp, u5;
    u5 = opx & 0x1f;
    tmp = this.gpr[ra];
...
def(0x033a, TYPE_R, function (ra, rb, rc) {
    var tmp, u5;
    u5 = this.gpr[rb] & 0x1f;
    tmp = this.gpr[ra];
    this.gpr[rc] = (tmp << u5) | (tmp >>> (32 - u5));
...
def(0x063a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = ~(this.gpr[ra] | this.gpr[rb]);
}, function (ra, rb, rc) {
    return D_RRR("nor", rc, ra, rb);
});

def(0x073a, TYPE_R, function (ra, rb, rc) {
    if (!this.cfg.mulx) {
        throw "Unsupported";
    }
    throw 0;
...
def(0x083a, TYPE_R, function (ra, rb, rc) {
...
def(0x0b3a, TYPE_R, function (ra, rb, rc) {
    var tmp, u5;
    u5 = this.gpr[rb] & 0x1f;
    tmp = this.gpr[ra];
...
def(0x0e3a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] & this.gpr[rb];
}, function (ra, rb, rc) {
    return D_RRR("and", rc, ra, rb);
});

def(0x103a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] < this.gpr[rb] ? 1 : 0;
}, function (ra, rb, rc) {
    return D_RRR("cmplt", rc, ra, rb);
});

def(0x123a, TYPE_R, function (ra, rb, rc, opx) {
    var u5;
    u5 = opx & 0x1f;
...
def(0x133a, TYPE_R, function (ra, rb, rc) {
    var u5;
    u5 = this.gpr[rb] & 0x1f;
    this.gpr[rc] = this.gpr[ra] << u5;
}, function (ra, rb, rc) {
...
def(0x143a, TYPE_R, function (ra, rb, rc) {
    throw 0;
}, function (ra, rb, rc) {
    return D_RR("wrprs", rc, ra);
});

def(0x163a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] | this.gpr[rb];
}, function (ra, rb, rc) {
    return D_RRR("or", rc, ra, rb);
});

def(0x173a, TYPE_R, function (ra, rb, rc) {
    if (!this.cfg.mulx) {
        throw "Unsupported";
    }
    throw 0;
...
def(0x1e3a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] ^ this.gpr[rb];
}, function (ra, rb, rc) {
    return D_RRR("xor", rc, ra, rb);
});

def(0x1f3a, TYPE_R, function (ra, rb, rc) {
    if (!this.cfg.mulx) {
        throw "Unsupported";
    }
    throw 0;
...
def(0x203a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] === this.gpr[rb] ? 1 : 0;
}, function (ra, rb, rc) {
    return D_RRR("cmpeq", rc, ra, rb);
});

def(0x243a, TYPE_R, function (ra, rb, rc) {
    if (!this.cfg.div) {
        throw "Unsupported";
    }
    throw 0;
...
def(0x253a, TYPE_R, function (ra, rb, rc) {
    if (!this.cfg.div) {
        throw "Unsupported";
    }
    throw 0;
...
def(0x263a, TYPE_R, function (ra, rb, rc, opx) {
    var n;
    n = opx & 0x1f;
    throw 0;
}, function (ra, rb, rc, opx) {
...
def(0x273a, TYPE_R, function (ra, rb, rc) {
    if (!this.cfg.mul) {
        throw "Unsupported";
    }
    throw 0;
...
def(0x283a, TYPE_R, function (ra, rb, rc) {
...
def(0x303a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = (this.gpr[ra] >>> 0) < (this.gpr[rb] >>> 0) ? 1 : 0;
}, function (ra, rb, rc) {
    return D_RRR("cmpgeu", rc, ra, rb);
});

def(0x313a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] + this.gpr[rb];
}, function (ra, rb, rc) {
    if (rb === ZR) {
...
def(0x393a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] - this.gpr[rb];
}, function (ra, rb, rc) {
    return D_RRR("add", rc, ra, rb);
});

def(0x3a3a, TYPE_R, function (ra, rb, rc, opx) {
    this.gpr[rc] = this.gpr[ra] >> (opx & 0x1f);
}, function (ra, rb, rc, opx) {
    return D_RRD("srai", rc, ra, opx & 0x1f);
});

def(0x3b3a, TYPE_R, function (ra, rb, rc) {
    this.gpr[rc] = this.gpr[ra] >> (this.gpr[rb] & 0x1f);
}, function (ra, rb, rc) {
